...
class RestaurantDB:
    ...
    def orderRestaurants(self, *criterion):
        return self.__session.query(Restaurant).order_by(*criterion).all()
    ...
    def orderMenuItems(self, *criterion):
        return self.__session.query(MenuItem).order_by(*criterion).all()